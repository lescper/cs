...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2015-03-12 9:38:49   N/A    初版
*
...
namespace FxProductMonitor.DAL
{
    ...
    public partial class ProductList
    {
        ...
        public int Add(FxProductMonitor.Model.ProductList model)
        {
            ...
            strSql.Append("productNo,productName,img,isOnlinepay,ticketCount,salePrice,cityName,cutPrice,marketPrice,express,orderDesc,priceStartDate,priceEndDate,viewName,viewLongitude,viewLatitude,viewAddress,viewId,interfaceId,interfaceProdId,state,ProductState,updateDate)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@orderDesc", SqlDbType.VarChar,50),
					...
					new SqlParameter("@viewLongitude", SqlDbType.VarChar,50),
					new SqlParameter("@viewLatitude", SqlDbType.VarChar,50),
					new SqlParameter("@viewAddress", SqlDbType.VarChar,50),
					new SqlParameter("@viewId", SqlDbType.VarChar,50),
					new SqlParameter("@interfaceId", SqlDbType.VarChar,50),
					new SqlParameter("@interfaceProdId", SqlDbType.VarChar,50),
        ...
        public FxProductMonitor.Model.ProductList GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,productNo,productName,img,isOnlinepay,ticketCount,salePrice,cityName,cutPrice,marketPrice,express,orderDesc,priceStartDate,priceEndDate,viewName,viewLongitude,viewLatitude,viewAddress,viewId,interfaceId,interfaceProdId,state,ProductState,updateDate from ProductList ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,productNo,productName,img,isOnlinepay,ticketCount,salePrice,cityName,cutPrice,marketPrice,express,orderDesc,priceStartDate,priceEndDate,viewName,viewLongitude,viewLatitude,viewAddress,viewId,interfaceId,interfaceProdId,state,ProductState,updateDate ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,productNo,productName,img,isOnlinepay,ticketCount,salePrice,cityName,cutPrice,marketPrice,express,orderDesc,priceStartDate,priceEndDate,viewName,viewLongitude,viewLatitude,viewAddress,viewId,interfaceId,interfaceProdId,state,ProductState,updateDate ");
            strSql.Append(" FROM ProductList ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
