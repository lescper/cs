...
namespace FxProductMonitor.DAL
{
    ...
    public partial class YFPWProducts
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "YFPWProducts");
        }
        ...
        public int Add(FxProductMonitor.Model.YFPWProducts model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@product_Introduction", SqlDbType.VarChar,2000),
					new SqlParameter("@product_instructions", SqlDbType.VarChar,2000),
					new SqlParameter("@scenic_name", SqlDbType.VarChar,255),
					new SqlParameter("@scenic_tel", SqlDbType.VarChar,50),
					new SqlParameter("@scenic_address", SqlDbType.VarChar,1000),
					new SqlParameter("@scenic_bus", SqlDbType.VarChar,1000),
        ...
        public FxProductMonitor.Model.YFPWProducts GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,product_id,product_name,product_facevalue,product_platformvalue,provide_salePrice,product_start,product_end,product_Introduction,product_instructions,scenic_name,scenic_tel,scenic_address,scenic_bus,scenic_drivingroute,product_Abstract,product_realnamestatus,product_limitstatus,product_maxpople,product_limittime,product_limitday,product_imgs,updated from YFPWProducts ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,product_id,product_name,product_facevalue,product_platformvalue,provide_salePrice,product_start,product_end,product_Introduction,product_instructions,scenic_name,scenic_tel,scenic_address,scenic_bus,scenic_drivingroute,product_Abstract,product_realnamestatus,product_limitstatus,product_maxpople,product_limittime,product_limitday,product_imgs,updated ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,product_id,product_name,product_facevalue,product_platformvalue,provide_salePrice,product_start,product_end,product_Introduction,product_instructions,scenic_name,scenic_tel,scenic_address,scenic_bus,scenic_drivingroute,product_Abstract,product_realnamestatus,product_limitstatus,product_maxpople,product_limittime,product_limitday,product_imgs,updated ");
            strSql.Append(" FROM YFPWProducts ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            string sql = "update YFPWProducts set updated=0";
            try
            {
