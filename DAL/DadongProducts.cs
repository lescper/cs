...
namespace FxProductMonitor.DAL
{
    ...
    public partial class DadongProducts
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "DadongProducts");
        }
        ...
        public int Add(FxProductMonitor.Model.DadongProducts model)
        {
            ...
            strSql.Append("product_id,category,product_name,product_faceValue,product_webValue,product_platformValue,product_ticketExplain,provide_address,product_image,product_expireTime,product_isSubscribe,product_payType,product_ifPassenger,product_passengerInfoNum,product_everyShareMany,product_needReserve,product_preTimeLimitType,product_hasMaxMobileLimit,product_refundSet,product_refundType,product_refundPoundageType,product_refundPoundage,whenTimePre,updated)");
            strSql.Append(" values (");
            strSql.Append("@product_id,@category,@product_name,@product_faceValue,@product_webValue,@product_platformValue,@product_ticketExplain,@provide_address,@product_image,@product_expireTime,@product_isSubscribe,@product_payType,@product_ifPassenger,@product_passengerInfoNum,@product_everyShareMany,@product_needReserve,@product_preTimeLimitType,@product_hasMaxMobileLimit,@product_refundSet,@product_refundType,@product_refundPoundageType,@product_refundPoundage,@whenTimePre,@updated)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@product_id", SqlDbType.Int,4),
					new SqlParameter("@category", SqlDbType.VarChar,255),
					...
					new SqlParameter("@product_refundType", SqlDbType.VarChar,50),
            ...
            parameters[3].Value = model.product_faceValue;
            parameters[4].Value = model.product_webValue;
            parameters[5].Value = model.product_platformValue;
            parameters[6].Value = model.product_ticketExplain;
            parameters[7].Value = model.provide_address;
            parameters[8].Value = model.product_image;
            parameters[9].Value = model.product_expireTime;
            parameters[10].Value = model.product_isSubscribe;
            parameters[11].Value = model.product_payType;
            parameters[12].Value = model.product_ifPassenger;
            parameters[13].Value = model.product_passengerInfoNum;
            parameters[14].Value = model.product_everyShareMany;
            parameters[15].Value = model.product_needReserve;
            parameters[16].Value = model.product_preTimeLimitType;
            parameters[17].Value = model.product_hasMaxMobileLimit;
            parameters[18].Value = model.product_refundSet;
            parameters[19].Value = model.product_refundType;
            parameters[20].Value = model.product_refundPoundageType;
            parameters[21].Value = model.product_refundPoundage;
            parameters[22].Value = model.whenTimePre;
            parameters[23].Value = model.updated;
        ...
        public FxProductMonitor.Model.DadongProducts GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,product_id,category,product_name,product_faceValue,product_webValue,product_platformValue,product_ticketExplain,provide_address,product_image,product_expireTime,product_isSubscribe,product_payType,product_ifPassenger,product_passengerInfoNum,product_everyShareMany,product_needReserve,product_preTimeLimitType,product_hasMaxMobileLimit,product_refundSet,product_refundType,product_refundPoundageType,product_refundPoundage,whenTimePre,updated from DadongProducts ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        public FxProductMonitor.Model.DadongProducts DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["product_refundType"] != null)
                {
                    model.product_refundType = row["product_refundType"].ToString();
                }
        ...
        {
            string sql = "select id from DadongProducts where product_id=" + productId;
            try
            {
        ...
        {
            string sql = "update DadongProducts set updated=0";
